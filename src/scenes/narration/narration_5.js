class Narration5 extends Phaser.Scene
{
    constructor() {
        super("narration5Scene")
    }
    ...
    create() {
        ...
        //full narration text
        const fullText = 'This tree looks a little different, but probably due to the fact the wing hit it really fast.'
        let displayed = ''
        let i = 0
